...
#include <linux/kthread.h>		//treading
...
/***********************************Declare Wait Queue***********************************/
DECLARE_WAIT_QUEUE_HEAD(wait_queue_hello);

/******************************Structuring the class and device*****************************/
dev_t dev = 0;
